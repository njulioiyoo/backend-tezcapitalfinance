    ...
    <Card>
        ...
        <CardContent class="space-y-6">
            <div class="grid gap-6">
                ...
                <div v-if="form.bilingual_enabled" class="p-4 bg-blue-50 border border-blue-200 rounded-lg dark:bg-blue-950/20 dark:border-blue-800/30">
                    <div class="flex items-start gap-3">
                        <Globe class="w-5 h-5 text-blue-600 mt-0.5 dark:text-blue-400" />
                        <div>
                            <h4 class="font-medium text-blue-900 mb-1 dark:text-blue-200">Bilingual Features Enabled</h4>
