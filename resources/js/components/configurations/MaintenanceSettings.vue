...
const saveSettings = () => {
    ...
    // Maintenance changes detected

    // Only save if there are changes
    if (changes.length > 0) {
        emit('bulkSave', 'maintenance', changes);
    } else {
        // No maintenance changes to save
    }
};
        ...
        <CardContent class="space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div class="border rounded-lg p-4 bg-muted/30">
                    ...
                    <div class="mt-2 text-center p-6 bg-background border rounded-lg">
                        <AlertTriangle class="mx-auto h-12 w-12 text-amber-500 dark:text-amber-400 mb-4" />
                        <h2 class="text-xl font-semibold mb-2">Maintenance Mode</h2>
                        <p class="text-muted-foreground whitespace-pre-line">{{ form.maintenance_message || 'No message set' }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <!-- End Time Display -->
                <div v-if="form.maintenance_end_time" class="p-3 bg-blue-50 border border-blue-200 rounded-lg dark:bg-blue-950/20 dark:border-blue-800/30">
