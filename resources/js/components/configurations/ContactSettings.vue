        ...
        <Card>
            ...
            <CardContent class="space-y-4">
                <div class="grid md:grid-cols-2 gap-4">
                    <div class="space-y-2">
                        ...
                        <Input
                            ...
                            :disabled="isLoading"
                            :class="{ 'border-destructive': form.social_media.facebook && !validateURL(form.social_media.facebook) }"
                        />
                        <p v-if="form.social_media.facebook && !validateURL(form.social_media.facebook)" class="text-sm text-destructive">
                    ...
                    <div class="space-y-2">
                        ...
                        <Input
                            ...
                            :disabled="isLoading"
                            :class="{ 'border-destructive': form.social_media.instagram && !validateURL(form.social_media.instagram) }"
                        />
                        <p v-if="form.social_media.instagram && !validateURL(form.social_media.instagram)" class="text-sm text-destructive">
                            Please enter a valid URL
                        </p>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <Input
                            ...
                            :disabled="isLoading"
                            :class="{ 'border-destructive': form.social_media.twitter && !validateURL(form.social_media.twitter) }"
                        />
                        <p v-if="form.social_media.twitter && !validateURL(form.social_media.twitter)" class="text-sm text-destructive">
                            Please enter a valid URL
                        </p>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <Input
                            ...
                            :disabled="isLoading"
                            :class="{ 'border-destructive': form.social_media.linkedin && !validateURL(form.social_media.linkedin) }"
                        />
                        <p v-if="form.social_media.linkedin && !validateURL(form.social_media.linkedin)" class="text-sm text-destructive">
                            Please enter a valid URL
                        </p>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <Input
                            ...
                            :disabled="isLoading"
                            :class="{ 'border-destructive': form.social_media.youtube && !validateURL(form.social_media.youtube) }"
                        />
                        <p v-if="form.social_media.youtube && !validateURL(form.social_media.youtube)" class="text-sm text-destructive">
                            Please enter a valid URL
                        </p>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <Input
                            ...
                            :disabled="isLoading"
                            :class="{ 'border-destructive': form.social_media.tiktok && !validateURL(form.social_media.tiktok) }"
                        />
                        <p v-if="form.social_media.tiktok && !validateURL(form.social_media.tiktok)" class="text-sm text-destructive">
                            Please enter a valid URL
                        </p>
                    </div>
                </div>
                ...
                <div class="mt-6 p-4 bg-muted/30 rounded-lg">
                    <Label class="text-sm font-medium text-foreground mb-3 block">Active Social Media Links:</Label>
