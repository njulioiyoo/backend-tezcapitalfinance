        ...
        <CardContent class="space-y-6">
                    ...
                    <div class="border-2 border-dashed border-input rounded-lg p-6 dark:border-input">
                        <div v-if="logoPreview" class="space-y-4">
                            <div class="flex items-center justify-center">
                                <img 
                                    :src="logoPreview.startsWith('data:') || logoPreview.startsWith('http') ? logoPreview : `/storage/${logoPreview}`" 
                                    alt="Logo Preview" 
            ...
            <div class="space-y-4">
                <div class="space-y-2">
                    ...
                    <div class="border-2 border-dashed border-input rounded-lg p-6 bg-gray-900 dark:bg-gray-800 dark:border-input">
                        <div v-if="logoDarkPreview" class="space-y-4">
                            <div class="flex items-center justify-center">
                                <img 
                                    :src="logoDarkPreview.startsWith('data:') || logoDarkPreview.startsWith('http') ? logoDarkPreview : `/storage/${logoDarkPreview}`" 
                        ...
                        <div v-else class="text-center">
                            ...
                            <p class="text-sm text-gray-300 dark:text-muted-foreground mt-2">PNG, JPG, SVG up to 5MB</p>
                        </div>
                        <input
                            ref="logoDarkInput"
                            type="file"
                ...
                <div class="space-y-2">
                    ...
                    <div class="border-2 border-dashed border-input rounded-lg p-6 dark:border-input">
                        <div v-if="faviconPreview" class="space-y-4">
                            <div class="flex items-center justify-center">
                                <img 
                                    :src="faviconPreview.startsWith('data:') || faviconPreview.startsWith('http') ? faviconPreview : `/storage/${faviconPreview}`" 
                                    alt="Favicon Preview" 
                        ...
                        <div v-else class="text-center">
                            <Image class="mx-auto h-8 w-8 text-muted-foreground" />
                            <div class="mt-2">
                            ...
                            <p class="text-sm text-muted-foreground mt-2">ICO, PNG 16x16 or 32x32</p>
                        </div>
                        <input
                            ref="faviconInput"
                            type="file"
