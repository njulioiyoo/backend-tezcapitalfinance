<template>
  <div class="space-y-6">
    ...
    <!-- Our Story Section -->
    <div v-if="section === 'our-story' || section === 'all'">
    <Card>
      <CardHeader>
    ...
    <!-- Vision Section -->
    <div v-if="section === 'vision' || section === 'all'">
    <Card>
      <CardHeader>
    ...
    <!-- Mission Section -->
    <div v-if="section === 'mission' || section === 'all'">
    <Card>
      <CardHeader>
        <CardTitle class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-2">
            <Button 
              v-if="!collapsedSections.mission"
        ...
        <CardDescription v-if="!collapsedSections.mission">
          Configure the Mission section content
        </CardDescription>
      </CardHeader>
      <Transition name="collapse">
        <CardContent v-if="!collapsedSections.mission" class="space-y-6">
          <div class="grid md:grid-cols-2 gap-4">
            <div class="space-y-2">
    ...
    <Card>
      <CardHeader>
        <CardTitle class="flex items-center justify-between">
          <div 
            class="cursor-pointer flex-1"
            @click="toggleSection('logoPhilosophy')"
          >
            <span>Logo Philosophy Section</span>
          </div>
          <div class="flex items-center gap-2">
            <Button 
              v-if="!collapsedSections.logoPhilosophy"
        ...
        <CardDescription v-if="!collapsedSections.logoPhilosophy">
          Configure the Logo Philosophy section content
        </CardDescription>
      </CardHeader>
      <Transition name="collapse">
        <CardContent v-if="!collapsedSections.logoPhilosophy" class="space-y-6">
          <div class="grid md:grid-cols-2 gap-4">
            <div class="space-y-2">
    ...
    <Card>
      <CardHeader>
        <CardTitle class="flex items-center justify-between">
          <div 
            class="cursor-pointer flex-1"
            @click="toggleSection('fastValues')"
          >
            <span>F.A.S.T Values Section</span>
          </div>
          <div class="flex items-center gap-2">
            <Button 
              v-if="!collapsedSections.fastValues"
              @click="addFastValue" 
              variant="outline" 
              size="sm"
            >
        ...
        <CardDescription v-if="!collapsedSections.fastValues">
          Configure F.A.S.T Values (Flexible, Agile, Solution-oriented, Trustworthy)
        </CardDescription>
      </CardHeader>
      <Transition name="collapse">
        <CardContent v-if="!collapsedSections.fastValues" class="space-y-6">
          <div class="grid md:grid-cols-2 gap-4">
            <div class="space-y-2">
    ...
    <Card>
      <CardHeader>
        <CardTitle class="flex items-center justify-between">
          <div 
            class="cursor-pointer flex-1"
            @click="toggleSection('idcValues')"
          >
            <span>I.D.C Values Section</span>
          </div>
          <div class="flex items-center gap-2">
            <Button 
              v-if="!collapsedSections.idcValues"
              @click="addIdcValue" 
              variant="outline" 
              size="sm"
            >
        ...
        <CardDescription v-if="!collapsedSections.idcValues">
          Configure I.D.C Values (Integrity, Dependable, Competent)
        </CardDescription>
      </CardHeader>
      <Transition name="collapse">
        <CardContent v-if="!collapsedSections.idcValues" class="space-y-6">
          <div class="grid md:grid-cols-2 gap-4">
            <div class="space-y-2">
    ...
    <Card>
      <CardHeader>
        <CardTitle 
          ...
          @click="toggleSection('closingStatement')"
        >
          <span>Closing Statement</span>
          <ChevronDown v-if="!collapsedSections.closingStatement" class="w-4 h-4" />
          <ChevronUp v-else class="w-4 h-4" />
        </CardTitle>
        <CardDescription v-if="!collapsedSections.closingStatement">
          Configure the closing statement for the About page
        </CardDescription>
      </CardHeader>
      <Transition name="collapse">
        <CardContent v-if="!collapsedSections.closingStatement" class="space-y-6">
          <div class="space-y-4">
            <div class="space-y-2">
...
import { Save, Plus, Trash2, ChevronDown, ChevronUp, Loader2, Upload, Image, X } from 'lucide-vue-next'
...
// Collapsible sections state - all sections collapsed by default
