        ...
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div v-for="location in locations.data" :key="location.id" class="relative overflow-hidden rounded-xl border border-sidebar-border/70 dark:border-sidebar-border group hover:shadow-lg transition-shadow">
                        <PlaceholderPattern />
                        <Card class="relative z-10 border-0 shadow-none bg-transparent">
                ...
                <!-- Pagination -->
                <div v-if="locations.links && locations.data?.length" class="relative overflow-hidden rounded-xl border border-sidebar-border/70 dark:border-sidebar-border">
                    <PlaceholderPattern />
                    <Card class="relative z-10 border-0 shadow-none bg-transparent">
