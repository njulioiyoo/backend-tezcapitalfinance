...
Route::prefix('v1')->group(function () {
    ...
    Route::get('services', [ContentController::class, 'servicesApi'])->name('api.services.index');
    Route::get('services/{id}', [ContentController::class, 'serviceDetailApi'])->name('api.services.show');
    ...
    Route::prefix('system')->name('api.system.')->group(function () {
        ...
        Route::prefix('content')->name('content.')->group(function () {
            ...
            Route::prefix('services')->name('services.')->group(function () {
                ...
                Route::post('/', [\App\Http\Controllers\Content\Services\ServiceController::class, 'store'])->name('store');
                ...
                Route::put('{service}', [\App\Http\Controllers\Content\Services\ServiceController::class, 'update'])->name('update');
                Route::delete('{service}', [\App\Http\Controllers\Content\Services\ServiceController::class, 'destroy'])->name('destroy');
                Route::post('bulk-action', [\App\Http\Controllers\Content\Services\ServiceController::class, 'bulkAction'])->name('bulk-action');
            });
            ...
            Route::post('update-event-statuses', [ContentController::class, 'updateEventStatuses'])->name('update-event-statuses');
        });
    });
